...
class StoryReadingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $params = [
            ...
            "bold" => "headed, strolled, Time flew by, giant","article_no" => $data_num, "tense_no" => "01", "updated_at" => Carbon::now(),"created_at" => Carbon::now()],
            ...
            "bold" => "village, science, confident, performance, productive","article_no" => $data_num++, "tense_no" => "01", "updated_at" => Carbon::now(),"created_at" => Carbon::now()],
        ];
