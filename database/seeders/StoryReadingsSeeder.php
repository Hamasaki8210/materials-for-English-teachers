...
class StoryReadingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $params = [
            ...
            "bold" => "headed,strolled,Time flew by,giant","article_no" => 1, "tense_no" => 1, "updated_at" => Carbon::now(),"created_at" => Carbon::now()],
            ...
            "bold" => "village,science,confident,performance,productive","article_no" => 2, "tense_no" => 1, "updated_at" => Carbon::now(),"created_at" => Carbon::now()],
        ];
